...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<style type="text/css">
!--
.floater { visibility:hidden; width:100%; height:100%; position:absolute; z-index:2; float:none; top:0px; left:0px; font-size:12px;}
...
body,td,th {
    ...
    background: #ffffff url(/images/skins/skin-epicduel-winter.jpg) fixed no-repeat top center;
}
.black-background {background: #ffffff;}
#skin-wrap {
	width: 100%;
}
#right-content {
...
.pinkText, .greenText {color: #ffffff!important}
.whiteText {color: #ffffff!important;}
.greenText1 {color: #ffffff!important}
.pinkText1 {color: #ffffff!important}
		</style>
	</head>
	<body> 
	 <div align="center"><strong><br />
	  <div align="center"><strong><br />
		...
		swfobject.embedSWF("<?php echo $sFile; ?>", "flashContent", "<?php echo $width; ?>", "<?php echo $height; ?>", "9.0", null, null, params, { name: "flashContent" });
	      </script>
        <noscript>
