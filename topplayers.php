...
if(isset($C_GET['mods']) && $C_GET['mods'] == 1) {
	$temp->content .= '<p><a href="topplayers.php?'.http_build_query(Array('mods' => 0) + $_GET, '', '&').'">Players and V.I.Ps only</a></p>';
} else {
	$temp->content .= '<p><a href="topplayers.php?'.http_build_query(Array('mods' => 1) + $_GET, '', '&').'">Include Mods and Admins</a></p>';
}
